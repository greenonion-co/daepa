...
const PetDetail = ({ pet }: PetDetailProps) => {
  ...
  return (
    <div className="mx-auto w-full max-w-[500px] px-4">
      <div
        ref={containerRef}
        className="scrollbar-hide relative h-[700px] w-full overflow-y-auto scroll-smooth rounded-lg border-4 border-gray-300 bg-white shadow-xl [-ms-overflow-style:'none'] [scrollbar-width:none] dark:bg-[#18181B] [&::-webkit-scrollbar]:hidden"
      >

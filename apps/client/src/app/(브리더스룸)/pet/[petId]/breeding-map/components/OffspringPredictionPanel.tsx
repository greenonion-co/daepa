...
export default function OffspringPredictionPanel({
  ...
  if (prediction.genes.length === 0) {
    return (
      <div className="pointer-events-auto flex w-full md:w-52 flex-col gap-2 rounded-xl border border-gray-200 bg-white/70 p-3 shadow-lg backdrop-blur-sm dark:border-gray-700 dark:bg-gray-900/70">
  ...
  return (
    <div
      className={`pointer-events-auto flex flex-col gap-2 rounded-xl border border-gray-200 bg-white/70 shadow-lg backdrop-blur-sm transition-all duration-200 dark:border-gray-700 dark:bg-gray-900/70 ${"w-full md:w-52 p-3"}`}
    >
      {/* 헤더 */}

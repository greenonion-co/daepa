...
const STATUS_STYLE: Record<string, string> = {
  ...
  [PetAdoptionDtoStatus.ON_SALE]:
    "bg-[#D3E5EF] text-[#28638D] dark:bg-[#1E3A5F] dark:text-[#A3C9E8]",
  [PetAdoptionDtoStatus.ON_RESERVATION]:
    "bg-[#FDECC8] text-[#9F6B15] dark:bg-[#4A3520] dark:text-[#F0C97E]",
};

const AdoptionStatusBadge = forwardRef<
  HTMLSpanElement,
  {
    status: PetAdoptionDtoStatus | null | undefined;
    className?: string;

...
const TextButton = () => (
  <div className="flex w-fit items-center rounded-lg px-2 py-1 hover:bg-[#f7f1e0] dark:hover:bg-gray-800">
    <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#542e12] text-[#f7f1e0] dark:bg-blue-900/50 dark:text-blue-400">
      <Plus className="h-3 w-3" />
    </div>
    <span className="px-2 py-1 text-[14px] font-[500] text-[#542e12] dark:text-blue-400">
      펫 추가하기
    </span>
  </div>
);
